...
<div class="floating-menu" style="bottom: 40px;height: 85px;">
 <span class="toolbar-link-title-icon mobile-fixed-menu_catalog_filters-open filters-button" style="background-color: #000;color: #dbdbdb;padding: 7px;">
  <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M5 12L5 4" stroke="#ffffff" stroke-linecap="round"></path> <path d="M19 20L19 17" stroke="#ffffff" stroke-linecap="round"></path> <path d="M5 20L5 16" stroke="#ffffff" stroke-linecap="round"></path> <path d="M19 13L19 4" stroke="#ffffff" stroke-linecap="round"></path> <path d="M12 7L12 4" stroke="#ffffff" stroke-linecap="round"></path> <path d="M12 20L12 11" stroke="#ffffff" stroke-linecap="round"></path> <circle cx="5" cy="14" r="2" stroke="#ffffff" stroke-linecap="round"></circle> <circle cx="12" cy="9" r="2" stroke="#ffffff" stroke-linecap="round"></circle> <circle cx="19" cy="15" r="2" stroke="#ffffff" stroke-linecap="round"></circle> </g></svg> <?php echo $ULang->t("Фильтры"); ?>  </span> 
</div>
</a>
