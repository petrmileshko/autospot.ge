		...
		<noindex>	
			...
			<body id="t">
				...
				<div id="main-frame-error" class="interstitial-wrapper" jstcache="0"> 
					...
					<div style="text-align: center; margin-bottom: 170px;"><img style="width: 260px;" src="https://autospot.ge/media/others/logo_646a0eceebde7.svg">
						<br/><div  style="text-align: center;"><?php echo $ULang->t("404 страница не существует!"); ?></div>
					</div>	
					...
					<div id="myBlock" style="text-align: center;"><?php echo $ULang->t("Нажмите на пробел"); ?></div>
					
					
					
					<br/>
					<a href="/"><button style="display: flex; justify-content: center; align-items: center; margin: 0 auto;" class="center-button css-1nebs3y"><?php echo $ULang->t("Вернуться на главную"); ?></button></a>
