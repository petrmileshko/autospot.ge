					...
					<a href="<?php echo $ads_url; ?>" title="<?php echo $ads_title; ?>">
						<div class='item-grid' title="<?php echo $ads_title; ?>">
							<div class="item-grid-img">
								...
								<!-- 18-08-2023 Correction 40 ( old code <img src="<?php echo $ads_img; ?>" class="image-autofocus ad-gallery-hover-slider-image lazyload" data-src="<?php echo $ads_title; ?>" data-key="0" alt="<?php echo $ads_title; ?>"> ) 
