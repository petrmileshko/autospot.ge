        ...
        <div class="filter-items filter-items-spacing" id-filter="'.$value["ads_filters_id"].'" main-id-filter="0" >
            ...
            <div class="col-lg-5" >
                ...
                <div class="filter-input" >
                  <div class="wb"><span>'.$ULang->t("от").'</span><input type="text" name="filter['.$value["ads_filters_id"].'][from]" value="'.$param["filter"][$value["ads_filters_id"]]["from"].'" /></div>
                  <div class="wb"><span>'.$ULang->t("до").'</span><input type="text" name="filter['.$value["ads_filters_id"].'][to]" value="'.$param["filter"][$value["ads_filters_id"]]["to"].'" /></div>
                </div>
