				...
				<div class="catalog-list-options toggle-list-options d filter-items" id="usdPriceBlock_l">
					<div class="filter-input">
						...
						<div class="wb">
							...
							<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnLARI_l">₾</span>
						</div>
					</div>
				</div>
				...
				<div class="catalog-list-options toggle-list-options d filter-items" id="lariPriceBlock_l" style="display: none;">
					<div class="filter-input">
						...
						<div class="wb">
							...
							<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnUSD_l">$</span>
						</div>
					</div>
				</div>
			...
			<div class="catalog-list-options toggle-list-options d filter-items" id="usdPriceBlock_m">
				<div class="filter-input">
					...
					<div class="wb">
						<span></span>
						<input type="text" placeholder=" <?php echo $ULang->t("до"); ?> $" name="filter[price_usd][to]" value="<?php if($data["param_filter"]["filter"]["price_usd"]["to"]) echo round($data["param_filter"]["filter"]["price_usd"]["to"],2); ?>" />
						<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnLARI_m">₾</span>
					</div>
				</div>
			</div>
			...
			<div class="catalog-list-options toggle-list-options d filter-items" id="lariPriceBlock_m" style="display: none;">
				<div class="filter-input">
					...
					<div class="wb">
						<span></span>
						<input type="text" placeholder=" <?php echo $ULang->t("до"); ?> ₾" name="filter[price][to]" value="<?php if($data["param_filter"]["filter"]["price"]["to"]) echo round($data["param_filter"]["filter"]["price"]["to"],2); ?>" />
						<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnUSD_m">$</span>
					</div>
				</div>
			</div>
			...
			<div class="catalog-list-options toggle-list-options d filter-items" id="usdPriceBlock_y">
				<div class="filter-input">
					...
					<div class="wb">
						<span></span>
						<input type="text" placeholder=" <?php echo $ULang->t("до"); ?> $" name="filter[price_usd][to]" value="<?php if($data["param_filter"]["filter"]["price_usd"]["to"]) echo round($data["param_filter"]["filter"]["price_usd"]["to"],2); ?>" />
						<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnLARI_y">₾</span>
					</div>
				</div>
			</div>
			...
			<div class="catalog-list-options toggle-list-options d filter-items" id="lariPriceBlock_y" style="display: none;">
				<div class="filter-input">
					...
					<div class="wb">
						<span></span>
						<input type="text" placeholder=" <?php echo $ULang->t("до"); ?> ₾" name="filter[price][to]" value="<?php if($data["param_filter"]["filter"]["price"]["to"]) echo round($data["param_filter"]["filter"]["price"]["to"],2); ?>" />
						<span class="text-right action-clear-filter b-currency" style="left: -14px;color: #fff;"  id="btnUSD_y">$</span>
					</div>
				</div>
			</div>
